...
export default class BoundEntity {
  ...
  inBounds () {
    return (
      numberUtils.inBound(this.position.x, this.bounds.x.MIN, this.bounds.x.MAX) &&
      numberUtils.inBound(this.position.y, this.bounds.y.MIN, this.bounds.y.MAX)
    )
  }
   ...
   */
  boundToBounds () {
    this.position.x = numberUtils.bound(
      this.position.x, this.bounds.x.MIN, this.bounds.x.MAX
    )
    this.position.y = numberUtils.bound(
